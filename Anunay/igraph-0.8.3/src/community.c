...
int igraph_modularity(const igraph_t *graph,
                      ...
                      const igraph_vector_t *weights,double gamma) {
...
static igraph_real_t igraph_i_multilevel_community_modularity(
    const igraph_i_multilevel_community_list *communities,double gamma ) {
...
static igraph_real_t igraph_i_multilevel_community_modularity_gain(
        ...
        igraph_real_t weight_all, igraph_real_t weight_inside,double gamma ) {
    IGRAPH_UNUSED(vertex);
    return weight_inside - gamma *
...
int igraph_community_multilevel(const igraph_t *graph,
                                ...
                                igraph_matrix_t *memberships, igraph_vector_t *modularity,double gamma) {
